(function () {
  ...
  function openProductFromUrl() {
    ...
    // any synchronous setup error (missing categories.js/supabase-config.js,
    // typo, etc.) lands here instead of silently killing the whole page
    ...
    if (el) {
      ...
      if (title) title.textContent = "Website gagal dimuat";
      if (sub) sub.textContent = "Error: " + (err && err.message ? err.message : String(err));
    }
  }
})();
